...
static u8g2_uint_t clampScrollSpeed(u8g2_uint_t scrollSpeedPxPerSec) {
...
static int64_t computeOnePixelDurationUs_(u8g2_uint_t scrollSpeedPxPerSec) {
  u8g2_uint_t s = clampScrollSpeed(scrollSpeedPxPerSec);
