...
class DisplayScrollText {
  ...
  int64_t startActiveMicros_; // absolute "time", when we become active - caution in MICROseconds

  int64_t lastScrollUpdateMicros_; // last time we updated the scroll position
